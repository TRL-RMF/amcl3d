...
private:
  ...
  /*!
   * \param initialpose User specified initial pose from Rviz panel
   * 
   * User can specifial 2D inital pose from RViz for ground robot use (2D only)
   */
  ...
  ros::Subscriber initialpose_sub_; /*!< Intial pose subscriber */
  ...
  ros::Publisher pose_pub_;           /*!< Estimated pose output not tf */
